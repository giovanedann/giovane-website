...
If you want to find something that will pay you a decent amount, you need to leave. And, since I'm a family guy, that was not an option, so I needed to find something that aligned better with my goals.
...
When you're a guy like me, with no background, no prestigious universities, no big-techs in the resume, no connections, no nothing, you need to find your way.

So, for me, the best way to prove people that I know what I do, is to *build in public* and create good content, who knows if I will help someone in the same place as I was.
...
So, what's better than writing technical and career posts to show people what you do?

### Claude Code for development

I found out about Claude Code 6~ months ago. And it was the best thing I could've discovered.
...
That is *IMPOSSIBLE*, and I repeat, *IMPOSSIBLE*, to build alone. Especially for me, with no previous game development experience.

Even if you're a guy who writes 3000 lines in 5 seconds in neovim, you're not making it.

But now, I have the fast fingers to build that, I just need to review.
...
Before I started building this website, I already had everything in my head: the stack (Next.js, Tailwind, shadcn/ui), the pages (/blog, /about, /game), the components, the structure. Claude Code didn't decide any of that. I did.
...
The secret? Treat it like a really fast junior dev who never gets tired. You give clear instructions, you review the output, and you iterate. That's it.

I do use Claude to help me think through problems - that's what *plan mode* is for. But I don't trust it blindly. I validate, I question, and I make the final calls. The AI proposes, I decide.

## Lessons Learned

I learned a lot with this project.

- How to run multiple agents (I built /about and /game pages in parallel)
- How to use skills
- How to prompt better
- How pro plan of claude code is just a scam for you to buy the max plan. (I swear, I tried sticking to the pro plan)

## Conclusion

To be honest, I did this in kind of a rush. I just want to deploy this website fast and let people play the typing game.

I hope that helped you to learn something, if you want to have a chat, feel free to reach out.
